...
Java_com_wangxingxing_beautyfacedemo_OpenCVJni_init(JNIEnv *env, jobject thiz, jstring path_,
                                                    jstring seeta_) {
...
Java_com_wangxingxing_beautyfacedemo_OpenCVJni_native_1detector(JNIEnv *env, jobject thiz,
    ...
    if (rects.size() > 0) {
        jclass faceClazz = env->FindClass("com/wangxingxing/beautyfacedemo/bean/Face");
        /**
